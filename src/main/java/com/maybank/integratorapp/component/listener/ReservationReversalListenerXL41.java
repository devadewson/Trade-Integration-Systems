...
public class ReservationReversalListenerXL41 implements CustomMessageListener {
    private static Logger log = LoggerFactory.getLogger(ReservationReversalListenerXL41.class);
    @Autowired
    ...
    private void processMessage(TextMessage message) {
        ...
        try {
            ...
            log.info("Limit Reversal Listener Received : "+message.getJMSCorrelationID());
