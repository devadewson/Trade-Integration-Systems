...
import com.maybank.integratorapp.model.restv2.AccountList.response.*;
import com.maybank.integratorapp.model.restv2.CustomerInformation.response.*;
...
//                System.out.println(message.getBody(String.class));
                ...
                com.maybank.integratorapp.model.restv2.CustomerInformation.response.MsgWraper customerInformationResponseWraper = new ObjectMapper().readValue(companyData.getCustInfoData(),
                        com.maybank.integratorapp.model.restv2.CustomerInformation.response.MsgWraper.class);

                com.maybank.integratorapp.model.restv2.AccountList.response.MsgWraper accountListResponseWrapper = new ObjectMapper().readValue(companyData.getAccInfoData(),
                        com.maybank.integratorapp.model.restv2.AccountList.response.MsgWraper.class);

                AccountListResponse accountListResponse = accountListResponseWrapper.getMsg().getMsgBody().getAccountListResponse();
...
//                CustomerInformationResponseData customerInformationResponseData = new CustomerInformationResponseData();
                CustomerInfoData customerInformationResponse = customerInformationResponseWraper.getMsg().getMsgBody().getCustomerInfoData();
...
//                customerInformationResponseData = customerInformationResponse.getCustomerInformationResponseData();
                customerDetailsResponse.setFullName(customerInformationResponse.getFullName());
                customerDetailsResponse.setCustomerNumber(customerInformationResponse.getgCIFNo());

                AddressDetails addressDetails = new AddressDetails();
                AddressDetail detailAddress = new AddressDetail();
                String fullAddress =
                        customerInformationResponse.getFullName() +" "+
                        System.lineSeparator()+
                                customerInformationResponse.getAddressLine1() + " " +
                                customerInformationResponse.getAddressLine2() + " " +
                                customerInformationResponse.getAddressLine3();
