    ...
    public String processMessage(String message,Long loggerId) {
        ...
        try {
            ...
            if (request != null) {
                ...
                // step 4.
                com.maybank.integratorapp.model.soap.limit.XL41.response.SoapEnvelope msgResponse = getMsgBodyResponse(msgRequest,eventCode,masterReference);
...
//        String correlationID = "ServiceRequest.getRequestHeader().getCorrelationID();";
    ...
    // step 4. Request data from core system
    public com.maybank.integratorapp.model.soap.limit.XL41.response.SoapEnvelope getMsgBodyResponse(SoapEnvelope soapEnvelopeXL41,String eventCode,String referenceId) {
