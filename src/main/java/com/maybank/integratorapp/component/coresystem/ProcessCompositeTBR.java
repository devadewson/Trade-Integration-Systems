...
//        CREDIT RPKP PUSAT 2999000880
        for (PostingExtender posting:
            ...
            if(posting.getDebitCreditFlag().equals("D")){
                ...
                account = "2999000880";
                PostingExtender DebitRPKP_PUSAT = makeShadowLeg(posting,"RPKP","C",groupId,branch,account);
